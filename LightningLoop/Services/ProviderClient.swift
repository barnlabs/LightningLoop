...
enum ProviderClientError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .piManagedProfile: "Built-in providers are managed by the LightningLoop runtime. Native direct requests are available only for LightningLoop-managed API-key presets (OpenRouter, GeneralCompute) or an explicitly selected Custom profile."
        }
    }
}
